                            ...
                            <div class="advanced-banner-content" style="min-height:400px">
                                <div class="advanced-banner-block   left" style="padding:20px;padding-top:0;padding-bottom:0;">
                                    <div class="advanced-banner-mb" style="display:table-cell;height:400px;vertical-align:middle;">
                                        ...
                                        <br>
                                        <a href="http://demo.cs-cart.ru/stores/8ae4a590ed09f99f/elektronika/mp3-pleery/naushniki/" class="ty-btn ty-btn__primary" >Просмотреть ассортимент</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="advanced-banner-content" style="min-height:400px">
                                ...
                                <div class="advanced-banner-block   left" style="padding:20px;padding-top:0;padding-bottom:0;">
                                    <div class="advanced-banner-mb" style="display:table-cell;height:400px;vertical-align:middle;">
                                        ...
                                        <br>
                                        <a href="http://demo.cs-cart.ru/stores/8ae4a590ed09f99f/elektronika/telefony/apple-iphone/" class="ty-btn ty-btn__primary" >Хочу его купить</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="advanced-banner-content" style="min-height:400px">
                                ...
                                <div class="advanced-banner-block   left" style="padding:20px;padding-top:0;padding-bottom:0;">
                                    <div class="advanced-banner-mb" style="display:table-cell;height:400px;vertical-align:middle;">
                                        ...
                                        <br>
                                        <a href="http://demo.cs-cart.ru/stores/8ae4a590ed09f99f/elektronika/telefony/samsung/" class="ty-btn ty-btn__primary" >Мне это интересно</a>
                                    </div>
                                </div>
                            </div>
                        </div>
